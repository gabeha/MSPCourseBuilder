...
<div class="flex container w-fit my-4 mx-auto">
  
  <!-- course bar -->
  <select @click = "inititalizeData" v-model="id" v-if="modules !== null" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 mx-4 mx-auto h-12 baseline" required>
...
<!-- column 1 -->
  <div class="flex flex-col container space-y-3">
  ...
  <div class="grid grid-cols-3 gap-10">
    <div class="space-x-6">
      ...
      <div class="flex container flex-col">
        ...
        <select v-model="subject" onchange='checkvalue(this.value)' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-28 p-2.5 mx-12 h-10" required>
...
<div class="grid grid-cols-3 gap-5 place-items-center">
  ...
  <div class="flex-col ">
    <input type="submit" value="SAVE" @click="getInputValue" class="mt-12 p-3 mx-4 mx-auto text-white bg-blue-900 rounded-md baseline hover:bg-blue-300">
  </div>
</div>

 <!-- Footer -->
    <footer class="bg-sky-600 mt-4" >
        <div class="container flex justify-evenly mx-auto pt-4">
            <!-- logo + description -->
            <div class="flex flex-col items-left justify-evenly space-y-0 mx-4">
                <div>
                    <img src="img/msp-logo.jpeg" class="h-20" alt="">
                </div>
            </div>
            <!-- description -->
            <div class="flex justify-around mx-4">
                <div class="text-white text-sm py-3">
                    <p> This website was built and designed by MSP students for </p>
                    <p> MSP students in the context of a research project. </p>
                    <p class="italic"> The only and one, MSPCourseBuilder team </p> 🙂
                </div>
            </div>
            <!-- links col 1 -->
            <div class="flex justify-around mx-4">
                <div class="flex flex-col space-y-2 text-white">
                    <a href="#" class="hover:text-sky-800">Home</a>
                    <a href="#" class="hover:text-sky-800">Course Builder</a>
                    <a href="#" class="hover:text-sky-800">Wiki</a>
                </div>
            </div>
            <!-- links col 2 -->
            <div class="flex justify-around mx-4">
                <div class="flex flex-col space-y-2 text-white">
                    <a href="#" class="hover:text-sky-800">About Us</a>
                    <a href="#" class="hover:text-sky-800">How to Get Started</a>
                    <a href="#" class="hover:text-sky-800">FAQ</a>
                </div>
            </div>
        </div>
        <div class="mx-auto text-center text-white pb-2">
            <!-- copyright -->
...
export default {
  ...
  methods: {
    ...
    async updateModule(){  
      const { data, error } = await supabase
      .from('testjens')
      .update({ 'period': this.period, 'code': this.code, 'subject': this.subject
              , 'hasprerec': this.noneChecker(this.pre_requisites), 'hascorec': this.noneChecker(this.co_requisites)
              , 'description': this.createJSON()
              , 'start1': this.createDate(this.day1,this.start_time_d1), 'end1': this.createDate(this.day1,this.end_time_d1)
              , 'start2': this.createDate(this.day2,this.start_time_d2), 'end2': this.createDate(this.day2,this.end_time_d2)
              , 'start3': this.createDate(this.day3,this.start_time_d3), 'end3': this.createDate(this.day3,this.end_time_d3)
