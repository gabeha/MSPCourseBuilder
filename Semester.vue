            ...
            <div :class="(subject == 'PRA') ? 'col-span-3' : 'col-span-1'" class="bg-gray-100 m-3  rounded-3xl" v-for="(subject, index) in sub" :key="index">
                ...
                <div class="grid grid-cols-4"> 
                    ...
                    :class=" (module.subject === 'BIO') ? 'text-green-500  col-span-2 '
                                    ...
                                    :'text-slate-600 col-span-1'" @click="makeChoice(module.id, module.subject, module.code, module.start1, module.end1, module.start2, module.end2, module.start3, module.end3, module.period, semester, this_period)">
...
export default {
    ...
    methods: {
        makeChoice(id, subject, code, start1, end1, start2, end2, start3, end3, period, semester, thisperiod) {
            this.$emit("makechoice", id, subject, code, start1, end1, start2, end2, start3, end3, period, semester, thisperiod)
        },
    }
}
